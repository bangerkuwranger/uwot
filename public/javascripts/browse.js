						...
						if (fieldType !== 'submit' && fieldType !== 'hidden') {
							...
							if (fieldType === 'radio') {
								...
								if (-1 !== nameIdx) {
									...
									fieldHtmlMap[nameIdx].values.push('<li class="uwot-browse-modal-content-li" data-form-id="' + formId + '" data-form-num="' + formIdx + '" data-field-num="' + nameIdx + '" data-field-name="' + fieldName + '" data-field-value-num="' + valueIdx + '" data-field-value="' + value + '"><span class="uwot-browse-modal-form-field-value-num">' + valueIdx + '</span>&nbsp;<span class="uwot-browse-modal-form-field-value">' + value +'</span></li>');
									
								}
								else {
									fieldHtmlMap.push({
										name: fieldName,
										open: '<li class="uwot-browse-modal-content-li" data-form-id="' + formId + '" data-form-num="' + formIdx + '" data-field-num="' + fieldIterator + '" data-field-name="' + fieldName + '" ' + 'data-field-type="' + fieldType + '"><span class="uwot-browse-modal-form-field-num">' + fieldIterator + '</span>&nbsp;<span class="uwot-browse-modal-form-field-name">',
										content: fieldName,
										close: '</li>',
										values: [
											'<li class="uwot-browse-modal-content-li" data-form-id="' + formId + '" data-form-num="' + formIdx + '" data-field-num="' + fieldIterator + '" data-field-name="' + fieldName + '" data-field-value-num="0" data-field-value="' + value + '"><span class="uwot-browse-modal-form-field-value-num">0</span>&nbsp;<span class="uwot-browse-modal-form-field-value">' + value +'</span></li>'
										]
									});
									fieldIterator++;
								}
								...
								let thisFieldObj = {
									name: fieldName,
									open: '<li class="uwot-browse-modal-content-li" data-form-id="' + formId + '" data-form-num="' + formIdx + '" data-field-num="' + fieldIterator + '" data-field-name="' + fieldName + '" ' + 'data-field-type="' + fieldType + '">',
									content: '<span class="uwot-browse-modal-form-field-num">' + fieldIterator + '</span>&nbsp;<span class="uwot-browse-modal-form-field-name">' + fieldName + '</span>',
									close: '</li>'
								};
