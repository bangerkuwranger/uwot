...
describe('config.js', function() {
	...
	describe('ExternalBinPath', function() {
		...
		describe('constructor', function() {
			...
			it('should accept three arguments, and assign the first arg(string) to pathName property, the second arg(string) to dirPath property, and the third arg(bool/string) to isSudoOnly property');
			it('should accept a single non-null object as an argument, assigning its pathName(string), dirPath(string), and isSudoOnly(bool/string) to the respective properties of itself');
			it('should truncate pathName property after first 255 characters');
			it('should truncate dirPath property after first 1024 characters');
			it('should cast isSudoOnly value to boolean, correctly assigning truthy and falsey values or strings ==="true" and "false"');
			it('should set its pathFiles property to an array generated by the getPathFiles method using the pathName property value');
			it('should throw an error if generated by running the getPathFiles method');
		
		});
		describe('getGeneric', function() {
		
			it('should be a function');
			it('should return a new object with name and path properties matching that of the instance, and constructor name "Object" rather than "ExternalBinPath"');
		...
		describe('getPathFiles', function() {
			...
			it('should assign passed callback function to the gpsCallback property of the calling instance');
			it('should return an error to callback if fs.stat of dirPath property value returns an error');
