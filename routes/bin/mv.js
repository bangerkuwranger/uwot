...
class UwotCmdMv extends global.Uwot.Exports.Cmd {
	...
	execute(args, options, app, user, callback, isSudo) {
		...
		try {
			...
			noOverwrite = 'object' === typeof args && Array.isArray(args) && args.length > 0 && 'object' === typeof args[2] && 'string' === typeof args[2].text ? sanitize.cleanBool(args[2].text.trim()) : false;
